...
// ngrok free plan intercepts browser requests with a warning page unless this header is present.
// Harmless when backend is not behind ngrok.
export const DEFAULT_HEADERS = BACKEND_URL.includes('ngrok')
