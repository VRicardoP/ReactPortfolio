...
// Saved searches tab — stored searches with inline run/results (formerly SavedSearchesWindow).
// Purely presentational: state/logic lives in useSavedSearches (passed in as `saved`),
